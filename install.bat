...
set "zipFile=Mini Converter.zip"
set "extractPath=Mini Converter"
...
start "" "%cd%\Mini Converter\instructions.html"

REM Notify the user
echo The ZIP file has been extracted. Please follow the instructions in the opened HTML file to install the Mini Converter.
